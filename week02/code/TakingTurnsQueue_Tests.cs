...
public class TakingTurnsQueueTests
{
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found:// Defect(s) Found: People with 0 turns are removed from the queue instead of
    // being re-added for infinite turns.
    ...
    // Defect(s) Found: People with negative turns are removed from the queue instead
    // of being re-added for infinite turns.
